...
import PasswordCheckList, { RuleNames } from "../index";
...
export const Default: Story = (args) => (
  <PasswordCheckList {...args} onChange={action("onChange")} />
);

// Story with a custom class name
export const WithCustomClassName: Story = (args) => (
  <PasswordCheckList {...args} onChange={action("onChange")} className="my-custom-class" />
);
...
export const CustomIconAndColors: Story = (args) => (
  <PasswordCheckList validTextColor="ForestGreen" invalidTextColor="fuchsia" validColor="#c7ad00" invalidColor="#380091" {...args} onChange={action("onChange")} />
);
